...
class EconomyHandler (private val apiBase: Base)
{
     ...
     *  Get Economy Items
     */
    class GetEconomyItems(private val category: String, private val status: Int, private val gender: Int) : Base
    {
        override fun callApi(listener: Base.OnApiResultListener)
        {
            GlobalScope.launch(Dispatchers.IO)
            {
                try
                {
                    ...
                    val result:GetEconomyItemsResult = apiInstance.getEconomyItems(category,status,gender)
