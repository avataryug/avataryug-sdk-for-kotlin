...
//        var accessToken: String? = accessHolder.getAccessToken()
        ...
        @JvmStatic
        val builder: OkHttpClient.Builder = OkHttpClient.Builder().readTimeout(5,TimeUnit.MINUTES)
    ...
    protected fun parameterToString(value: Any?): String = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
        when (value) {
            null -> ""
