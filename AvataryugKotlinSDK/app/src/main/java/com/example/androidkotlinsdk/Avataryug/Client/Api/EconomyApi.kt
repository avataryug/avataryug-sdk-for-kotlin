...
class EconomyApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getEconomyItems(category: kotlin.String, status: kotlin.Int, gender: kotlin.Int ,offset:kotlin.Int ,limit:kotlin.Int) : GetEconomyItemsResult {
        val localVarResponse = getEconomyItemsWithHttpInfo(category = category, status = status, gender = gender,offset = offset , limit = limit)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getEconomyItemsWithHttpInfo(category: kotlin.String, status: kotlin.Int, gender: kotlin.Int,offset:kotlin.Int ,limit:kotlin.Int) : ApiResponse<GetEconomyItemsResult?> {
        val localVariableConfig = getEconomyItemsRequestConfig(category = category, status = status, gender = gender ,offset = offset ,limit = limit)
     ...
     * @return RequestConfig
     */
    fun getEconomyItemsRequestConfig(category: kotlin.String, status: kotlin.Int, gender: kotlin.Int,offset:kotlin.Int ,limit:kotlin.Int) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>()
            .apply {
