...
class AvatarManagementApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getUserAvatarAllData(avatarID: kotlin.String, platform: kotlin.String) : GetUserAvatarAllDataResult {
        val localVarResponse = getUserAvatarAllDataWithHttpInfo(avatarID = avatarID, platform = platform)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as GetUserAvatarAllDataResult
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getUserAvatarAllDataWithHttpInfo(avatarID: kotlin.String, platform: kotlin.String) : ApiResponse<GetUserAvatarAllDataResult?> {
        val localVariableConfig = getUserAvatarAllDataRequestConfig(avatarID = avatarID, platform = platform)

        return request<Unit, GetUserAvatarAllDataResult>(
            localVariableConfig
        )
    }

    fun getUserAvatarAllDataRequestConfig(avatarID: kotlin.String, platform: kotlin.String) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>()
            .apply {
